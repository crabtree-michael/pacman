...
/**
 * Virtual joystick logic — dead zone, angular sectors, 4-way snapping.
 *
...
export class VirtualJoystick implements InputSource {
   ...
   * is a layout constant — the view re-measures it whenever the page re-lays
   * out, never on pointerdown.
   */
